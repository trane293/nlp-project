...
# define LSTM
model = Sequential()
model.add(Embedding(input_dim=len(orig_dict), output_dim=220, input_length=n_timesteps)) # dictionary size, embedding vector size, timesteps
...
mc = ModelCheckpoint(parent_path + 'checkpoints_deeper_net/' + 'model.seq2seq_nl_deeper_{epoch:02d}-{val_acc:.2f}.hdf5',
                                monitor='val_acc',
                                verbose=0,
...
history = model.fit(X_train, y_train, epochs=20,
          batch_size=200, verbose=1, validation_data=[X_test, y_test], callbacks=[mc])
model.save('/home/asa224/Desktop/students_less_asa224/Test Folder on Less/checkpoints_deeper_net/model_deeper.h5')
